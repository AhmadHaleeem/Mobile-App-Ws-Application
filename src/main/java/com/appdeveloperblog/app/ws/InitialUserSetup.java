...
public class InitialUserSetup {
	...
	@EventListener // to be fired when spring application starting up
	@Transactional
	public void onApplicationEvent(ApplicationReadyEvent event) {
		...
		adminUser.setFirstName("Ahmad");
		adminUser.setLastName("Abdelhaleem");
		adminUser.setEmail("ahmadhaleem1992@gmail.com");
		adminUser.setEmailVerificationStatus(true);
		adminUser.setUserId(utils.generateUserId(30));
		//adminUser.setPassword("123123");
		adminUser.setEncryptedPassword(bCryptPasswordEncoder.encode("123123"));
