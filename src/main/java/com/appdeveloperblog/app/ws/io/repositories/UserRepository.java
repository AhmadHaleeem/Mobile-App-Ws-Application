...
public interface UserRepository extends PagingAndSortingRepository<UserEntity, Long> {
	...
	Page<UserEntity> findAllUsesWithConfirmedEmailAddress(Pageable pageableRequest);
	...
	List<Object[]> findUserFirstNameAndLastNameKeyword(@Param("keyword") String keyword);
