...
public class AmazonSES {
	...
	final String FROM = "ahmadhaleem1992@gmail.com";
	...
	final String HTMLBODY = "<h1>Please verify your email address</h1>"
			...
			+ "<a href='http://ec2-3-127-38-95.eu-central-1.compute.amazonaws.com:8080/verification-service/email-verification.html?token=$tokenValue'>"
	...
	final String TEXTBODY = "Please verify your email address. "
			...
			+ " http://ec2-3-127-38-95.eu-central-1.compute.amazonaws.com:8080/verification-service/email-verification.html?tokenn=$tokenValue"
			+ " Thank you! And we are waiting for you inside!";
	...
	public void verifyEmail(UserDto userDto) {
		...
		System.setProperty("aws.accessKeyId", "AKIAZ5OABNVCRXAANPTQ"); 
		System.setProperty("aws.secretKey", "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"); 
